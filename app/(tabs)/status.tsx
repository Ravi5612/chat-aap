            ...
            <ScrollView className="flex-1">
                ...
                >
                    <View className="relative">
                            ...
                            <View className="w-full h-full rounded-full overflow-hidden bg-gray-100 items-center justify-center">
                                {myStatuses?.length > 0 ? (
                                    myStatuses[0].media_type === 'text' ? (
                                        ...
                                        <Image source={{ uri: myStatuses[0].media_url }} className="w-full h-full" />
                                    )
                                ) : (
                                    <Image
                        ...
                        <TouchableOpacity
                            onPress={() => setShowAddStatus(true)}
                            className="absolute bottom-0 right-0 bg-[#F68537] rounded-full p-1 border-2 border-white"
                        >
                    ...
                    <View className="ml-4 flex-1">
                        ...
                        <Text className="text-gray-500">
                            {myStatuses?.length > 0 ? 'Tap to view your updates' : 'Tap the plus to add an update'}
                        </Text>
                    </View>
                </TouchableOpacity>
                ...
                <View className="bg-gray-50 px-4 py-2">
                    <Text className="text-gray-500 font-bold text-xs uppercase">Recent updates</Text>
                </View>
