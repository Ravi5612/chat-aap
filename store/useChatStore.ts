...
export const useChatStore = create<ChatState>((set, get) => {
    ...
    return {
        ...
        sendMessage: async (text, friendId, currentUser, isGroup, replyToId, messageType, disappearingDuration, scheduledAt) => {
            const { createChatSendActions } = require('./chat/chatSendActions');
            const actions = createChatSendActions(set as any, get as any);
            return actions.sendMessage(text, friendId, currentUser, isGroup, replyToId, messageType, disappearingDuration, scheduledAt);
        },
