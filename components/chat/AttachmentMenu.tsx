...
export default function AttachmentMenu({ onLocation, onContact, onImage, onCamera, onDocument, onSchedule }: AttachmentMenuProps) {
    ...
    const items = [
        ...
        { label: 'Schedule', icon: 'time', color: '#F59E0B', onPress: onSchedule || (() => {}) },
